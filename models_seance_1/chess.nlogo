...
to move-bishop
  ...
  [
   ...
   if choice = 0 [
     ...
     set heading -45
     if can-move? 1 [
       move-to patch-at-heading-and-distance -45 1
     ]
    ]
   ...
   if choice = 2 [
     ...
     set heading -135
     if can-move? 1 [
       move-to patch-at-heading-and-distance -135 1
     ]
    ]
   ...
   ask patch-here [
     ...
     set pcolor ceiling pcolor + 1
    ;; if pcolor = 105 or pcolor = 15 [set pcolor 0]
     ]
  ]
end
